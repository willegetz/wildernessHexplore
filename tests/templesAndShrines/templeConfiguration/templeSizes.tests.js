...
const templeSizesModule = require('../../../src/templesAndShrines/templeConfiguration/templeSizes');
const rpgDiceRollerWrapper = require('../../../src/wrappers/rpgDiceRollerWrapper');

describe('templeSizes', function () {
    let d6Stub;
    let d10Stub;
    ...
    describe('getTempleSize', function () {
        it('returns "1 story" when a 1 is rolled', function () {
            ...
            const templeSizes = templeSizesModule(rpgDiceRollerWrapper);

            const sizeOfTemple = templeSizes.getTempleSize();
